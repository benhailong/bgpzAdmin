...
<div class="content">
    <form class="form-vertical login-form">
        <h3 class="form-title">{$Think.lang.adminlogin_title}</h3>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-user"></i>
                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="{$Think.lang.adminlogin_username}"
                           name="username"/>
                </div>
            </div>
        </div>
            ...
            <div class="controls">
                <div class="input-icon left">
                    ...
                    <input class="m-wrap placeholder-no-fix" type="password"
                           placeholder="{$Think.lang.adminlogin_password}" name="password"/>
                </div>
            </div>
        </div>
        <div class="form-actions">
            <!--<label class="checkbox">
                <input type="checkbox" name="remember" value="1"/> {$Think.lang.adminlogin_remember}
            </label>-->
            <button type="submit" class="btn green pull-right">
                {$Think.lang.adminlogin_login} <i class="m-icon-swapright m-icon-white"></i>
            </button>
        </div>
    ...
    <form class="form-vertical register-form" action="index.html">
        ...
        <div class="control-group">
            <div class="controls">
                <label class="checkbox">
                    <input type="checkbox" name="tnc"/> I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy
                        Policy</a>
                </label>
